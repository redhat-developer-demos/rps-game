...
import { SSEType, SSEContentStart, SSEContentStop, SSEContentEnd, SSEContentResult, SSE, SSEContentUserShape } from "./Api";
    ...
    function processMessage (message: SSE<unknown>) {
      switch (message.type) {
        case SSEType.Start:
          send({
            type: 'START',
            data: message.content as SSEContentStart
          })
          break;
        case SSEType.Stop:
          send({
            type: 'STOP',
            data: message.content as SSEContentStop
          })
          break;
        case SSEType.End:
          send({
        ...
        case SSEType.Result:
          send({
            type: 'RESULT',
            data: message.content as SSEContentResult
          })
          break;
        case SSEType.UserShape:
          send({
            type: 'USER_SHAPE',
            data: message.content as SSEContentUserShape
          })
          break;
        default:
